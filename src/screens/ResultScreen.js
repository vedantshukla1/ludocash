...
const Confetti = ({
  ...
  useEffect(() => {
    const run = () => {
      ...
      opacity.setValue(1);
      rotate.setValue(0);
      Animated.parallel([Animated.timing(y, {
        toValue: height + 20,
        ...
        duration: 2000,
        useNativeDriver: true
      }), Animated.sequence([Animated.delay(1800), Animated.timing(opacity, {
        toValue: 0,
        duration: 700,
        useNativeDriver: true
...
const ResultScreen = ({
  ...
  useEffect(() => {
    refreshUser();
    Animated.sequence([Animated.parallel([Animated.spring(trophyScale, {
      toValue: 1,
      tension: 60,
      friction: 6,
      useNativeDriver: true
      ...
      duration: 800,
      useNativeDriver: true
    })]), Animated.parallel([Animated.timing(cardOpacity, {
      toValue: 1,
      duration: 400,
      useNativeDriver: true
  ...
  const confettiParticles = isWinner ? Array.from({
    length: 40
  }, (_, i) => ({
    id: i,
    delay: i * 60,
  ...
  return <LinearGradient colors={GRADIENTS.background} style={styles.container}>
      ...
      {/* Confetti */}
      {confettiParticles.map(p => <Confetti key={p.id} delay={p.delay} color={p.color} />)}
      ...
      transform: [{
        ...
        color: isWinner ? COLORS.gold : COLORS.textSecondary
      }]}>
      ...
      transform: [{
        ...
        {isWinner && <Animated.View style={[styles.prizeRow, {
        opacity: prizeAnim
      }]}>
        ...
        <View style={styles.summaryRows}>
          ...
          <View style={styles.summaryRow}>
            ...
            <View style={styles.winnerRow}>
              ...
              backgroundColor: getColorHex(result.winner.color)
            }]} />
